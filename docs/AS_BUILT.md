...
**M6a (search) complete in code** — the first half of the plan's M6, on top of
M1–M5. Tags and permission editing are **M6b, a separate PR**; nothing here
touches them.
